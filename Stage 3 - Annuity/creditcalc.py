...
def main():
    ...
    parser.add_argument("--interest", type=float, help="loan interest rate without a percent sign")
    ...
    if args.principal is None:
        principal = calc_principal(args.payment, args.periods, args.interest)
        print(f"Your loan principal = {principal}!")

    elif args.payment is None:
        payment = calc_payment(args.principal, args.periods, args.interest)
        print(f"Your monthly payment = {payment}!")
    elif args.periods is None:
        periods = calc_periods(args.principal, args.payment, args.interest)
